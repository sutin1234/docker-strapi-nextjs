...
checkFields<Diff<{
  ...
  ${options.type === "page" || options.type === "route" ? "runtime?: 'nodejs' | 'experimental-edge' | 'edge'" : ""}
  ${options.type === "route" ? "" : `
  metadata?: any
...
class NextTypesPlugin {
    ...
    apply(compiler) {
        ...
        const handleModule = async (mod, assets)=>{
            ...
            const relativeImportPath = _path.default.join(this.getRelativePathFromAppTypesDir(relativePathToApp)).replace(/\.(js|jsx|ts|tsx|mjs)$/, "").replace(/\\/g, "/");
            const assetPath = assetDirRelative + "/" + (0, _normalizepathsep.normalizePathSep)(typePath);
            if (IS_LAYOUT) {
        ...
        compiler.hooks.compilation.tap(PLUGIN_NAME, (compilation)=>{
            compilation.hooks.processAssets.tapAsync({
                ...
                if (this.typedRoutes) {
                    ...
                    const packageJsonTypePath = _path.default.join("types", "package.json");
                    const packageJsonAssetPath = assetDirRelative + "/" + (0, _normalizepathsep.normalizePathSep)(packageJsonTypePath);
                    ...
                    const linkAssetPath = assetDirRelative + "/" + (0, _normalizepathsep.normalizePathSep)(linkTypePath);
